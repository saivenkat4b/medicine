...
if st.button('Predict'):
    ...
    # Add symptom and recommended medicine to session state chat history
    st.session_state['chat_history'].append((symptom, recommended_medicine))

st.subheader("Medicine Recommendation Chat History")

for symptom, medicine in st.session_state['chat_history']:
    st.write(f"Symptom: {symptom}, Recommended Medicine: {medicine}")